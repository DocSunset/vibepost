...
- Local model vs API model for the agent: a local model (Gemma 3, Phi-4) running
  in the browser via WebAssembly (transformers.js, llama.cpp WASM) would make the
  free tier genuinely serverless for AI too. Quality tradeoff is significant today
